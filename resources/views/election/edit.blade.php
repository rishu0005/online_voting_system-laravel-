...
<div class="container  margin-left pt-5">
    <div class="form-container margin-left  mt-0">
        <div class="header">
            <h2><i class="bi bi-calendar-plus me-2"></i> Edit : {{ $election->election_name }} </h2>
            {{-- <p class="text-muted">Fill in the details to create a new election in the system</p> --}}
        </div>
        
        <form id="electionForm" action="{{ route('updateElectionData') }}" method="POST">      
            @csrf
            @if (session('success'))
            ...
            <div class="mb-4">
                <div class="form-floating">
                    ...
                    <input type="text" class="form-control" id="election_name" name="election_name" value="{{ $election->election_name }}" placeholder="Election Name" >
            ...
            <div class="mb-4">
                <div class="form-floating">
                    <input type="text" class="form-control" id="election_year" value="{{ $election->election_year }}" name="election_year" placeholder="Election Year" >
            ...
            <div class="mb-4">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <div class="form-floating">
                            <input type="datetime-local" value="{{ $election->start_time }}" class="form-control" id="start_time" name="start_time" >
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-floating">
                            <input type="datetime-local" class="form-control" value="{{ $election->end_time }}" id="end_time" name="end_time" >
            ...
            <div class="mb-4">
                ...
                <div class="status-selector d-flex">
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="status" id="statusUpcoming" value="upcoming" {{ $election->status == 'upcoming' ? 'checked' : ''}} checked>
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="status" id="statusActive" {{ $election->status == 'active' ? 'checked' : ''}}   value="active">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="status" {{ $election->status == 'closed' ? 'checked' : ''}}  id="statusClosed" value="closed">
            ...
            <div class="d-flex justify-content-end mt-5">
                ...
                <button type="submit" class="btn btn-submit bg-primary text-white">Update Election</button>
            </div>
        </form>
    </div>
</div>
