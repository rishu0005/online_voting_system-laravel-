...
<div class="main-content">
    ...
    <div class="container px-4">
        ...
        <div class="div">
            ...
            {{-- <h3 class="text-center mb-4">Are You interested ?</h3> --}}
            <div class="d-flex gap-5">


                <form action="{{ route('apply-election-form') }}" method="post">
                    @csrf
                 
                    <input type="hidden" name="election_id" value="{{ $election_id->id }}">
                    @if ($errors->any())
                ...
                <a href="{{ route('elections') }}" class="text-decoration-none">
