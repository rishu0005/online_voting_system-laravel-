          ...
          <div class="col-lg-8">
              <div class="card">
                  <div class="card-header p-3 d-flex justify-content-between align-items-center">
                      <h5 class="mb-0">Schedule Elections</h5>
                      <div class="dropdown">
                  ...
                  <div class="card-body">
                      ...
                      <div class="election-card p-3 mb-3 position-relative">
                        ...
                        <h5>{{ $election->election_name }}</h5>
                        <div class="small text-muted mb-2 d-flex gap-5">
                            
                            <span class="d-inline-block">Start time : <x-date-countdown class="d-inline-block" :date="$election->start_time" />
                               
                               

                            </span>
                            <span class="">End time :  <x-date-countdown :date="$election->end_time" /></span>
                        ...
                        <a href="{{ route('apply-election',$election->id) }} " class="text-decoration-none">

                            <button class="btn btn-sm bg-primary text-light">Apply For This Election</button>
                        </a>
